$(function() {
	...
	banner = {
		pho : [{
				img : 'img/basic/bg1.jpg',
				color : '#e7e9e8'
			},{
				img : 'img/basic/bg2.jpg',
				color : '#ecf0fc'
			},{
				img : 'img/basic/bg3.jpg',
				color : '#e2e2e2'
			},{
				img : 'img/basic/bg4.jpg',
				color : '#ffffff'
			},{
				img : 'img/basic/bg5.jpg',
				color : '#f3f3f3'
			},{
				img : 'img/basic/bg6.jpg',
				color : '#ebdebe'
			}],
		//轮播器计数器
		index : 1,
	...
	function bannerFn(obj) {
		...
		$("#logDiv").css('background', "url(" + banner.pho[$(obj).index()].img + ") no-repeat center");
	}
	function banner_fn() {
